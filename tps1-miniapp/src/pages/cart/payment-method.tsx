      ...
      <div className="p-4 pt-2">
        <div className="flex items-center space-x-3 text-base font-medium bg-primary/10 text-primary border border-primary rounded-lg p-3">
          <div className="flex-1">
            <span className="block text-sm">Trực tiếp</span>
            <span className="block text-xs font-normal text-primary/80 mt-0.5">Nhân viên sale sẽ xác nhận đơn hàng sau</span>
          </div>
